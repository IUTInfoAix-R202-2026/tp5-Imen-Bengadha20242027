...
// sert à créer une boîte à outils (DataSource) qui connecte L' application
// à un vrai fichier de base de données
// tout en interdisant d'enregistrer des informations fausses ou incomplètes.
